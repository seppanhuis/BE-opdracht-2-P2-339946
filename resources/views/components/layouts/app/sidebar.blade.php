    ...
    <flux:sidebar sticky stashable class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
        ...
        <flux:navlist variant="outline">
            <flux:navlist.group :heading="__('Platform')" class="grid">
                ...
                <flux:navlist.item icon="archive-box-x-mark" :href="route('delivery.overview')"
                    :current="request()->routeIs('delivery.*')" wire:navigate>{{ __('Uit assortiment') }}
                </flux:navlist.item>
        ...
        @else
            <div class="hidden lg:block">
                <a href="{{ route('login') }}"
                    class="inline-flex items-center rounded-md bg-neutral-200 px-3 py-2 text-sm font-medium text-black dark:bg-neutral-700 dark:text-white">
                    {{ __('Log In') }}
                </a>
            </div>
        @endauth
